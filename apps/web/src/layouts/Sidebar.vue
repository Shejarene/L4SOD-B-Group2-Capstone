<template>
  ...
  >
    <div class="flex items-center h-16 px-4 border-b border-gray-200 dark:border-gray-700">
      <i class="pi pi-graduation-cap text-2xl text-primary-600 mr-3"></i>
...
const menuItems = [
  ...
  { label: 'Attendance Analytics', icon: 'pi pi-chart-bar', to: '/app/attendance/analytics', roles: ['super_admin', 'admin', 'principal', 'dos', 'teacher'] },
