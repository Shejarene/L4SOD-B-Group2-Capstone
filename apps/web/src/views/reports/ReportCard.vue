...
const loadReport = async () => {
  ...
  try {
    ...
    toast.add({ severity: 'error', summary: 'Error', detail: err.message || 'Failed to load report', life: 3000 })
...
const emailReport = async () => {
  ...
  try {
    ...
    toast.add({ severity: 'error', summary: 'Error', detail: err.message || 'Failed to email', life: 3000 })
